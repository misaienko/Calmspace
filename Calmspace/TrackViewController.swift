...
class TrackViewController: UIViewController,  FSCalendarDelegate, FSCalendarDataSource, FSCalendarDelegateAppearance {
    ...
    NSLayoutConstraint.activate([
            ...
            prevMonthButton.leadingAnchor.constraint(equalTo: calendarView.leadingAnchor, constant: 20), // Move it a bit towards the center

            nextMonthButton.topAnchor.constraint(equalTo: calendarView.topAnchor, constant: 10),
            nextMonthButton.trailingAnchor.constraint(equalTo: calendarView.trailingAnchor, constant: -20), // Move it a bit towards the center
        ])
    ...
    func calendar(_ calendar: FSCalendar, appearance: FSCalendarAppearance, titleOffsetFor date: Date) -> CGPoint {
        // Keep the title at its default position
